...
public class Fecha {
  ...
  public Fecha(int dia, int mes, int anio) throws ArithmeticException {
    if (mes < 1 || mes > 12)
      throw new ArithmeticException("Los meses van del 1 al 12. Vuelva a intenarlo.");

    if ((dia < 1 || dia > 31))
      throw new ArithmeticException("Los dias van del 1 al 31. Vuelva a intenarlo.");

    if (mes == 2 && dia > 29)
      throw new ArithmeticException("Febrero no puede tener más de 29 días.");
